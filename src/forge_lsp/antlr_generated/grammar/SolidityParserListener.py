# Generated from grammar/SolidityParser.g4 by ANTLR 4.13.2
from antlr4 import *
if "." in __name__:
...
class SolidityParserListener(ParseTreeListener):
    ...
    def enterUsingAliases(self, ctx:SolidityParser.UsingAliasesContext):
        pass

    # Exit a parse tree produced by SolidityParser#usingAliases.
    def exitUsingAliases(self, ctx:SolidityParser.UsingAliasesContext):
        pass
    ...
    def enterAddressPayable(self, ctx:SolidityParser.AddressPayableContext):
        pass

    # Exit a parse tree produced by SolidityParser#addressPayable.
    def exitAddressPayable(self, ctx:SolidityParser.AddressPayableContext):
        pass
